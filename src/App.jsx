      ...
      <div className='about' ref={ref}>
        ...
        <div className='about-photo'>
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <img src="/renan.png" alt="profile-photo" />
          </motion.div>
        ...
        >
          ...
          <div className='social-links'>
            ...
            <a
              ...
              style={{ minWidth: '120px', justifyContent: 'center' }} // Garante que o texto caiba sem pular
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
              </svg>
              <span>{emailCopied ? "Endereço Copiado!" : "Email"}</span>
            </a>

            {/* WHATSAPP*/}
            <a href="https://wa.me/5514981732117" target="_blank" rel="noopener noreferrer" className='social-btn whatsapp'>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
